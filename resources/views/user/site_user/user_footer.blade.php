                                    ...
                                    <ul class="clearfix">
                                        <li class="last">
                                            <div class="thumb images-hover">
                                                ...
                                                <a href="#">
                                                    <span><img src="{{asset('images/flickr/1.jpg')}}" alt="image"></span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="last">
                                            <div class="thumb images-hover">
                                                <div class="overlay"></div>
                                                <a href="#">
                                                    <span><img src="{{asset('images/flickr/2.jpg')}}" alt="image"></span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="last">
                                            <div class="thumb images-hover">
                                                <div class="overlay"></div>
                                                <a href="#">
                                                    <span><img src="{{asset('images/flickr/3.jpg')}}" alt="image"></span>
                                                </a>
                                            </div>
                                        </li>                            
                                        <li>
                                            <div class="thumb images-hover images-hover">
                                                <div class="overlay"></div>
                                                <a href="#">
                                                    <span><img src="{{asset('images/flickr/4.jpg')}}" alt="image"></span>
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="thumb images-hover">
                                                <div class="overlay"></div>
                                                <a href="#">
                                                    <span><img src="{{asset('images/flickr/5.jpg')}}" alt="image"></span>
                                                </a>
                                            </div>
                                        </li>
                                        <li class="last">
                                            <div class="thumb images-hover">
                                                <div class="overlay"></div>
                                                <a href="#">
                                                    <span><img src="{{asset('images/flickr/6.jpg')}}" alt="image"></span>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
